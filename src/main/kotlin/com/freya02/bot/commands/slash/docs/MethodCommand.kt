...
@CommandMarker
class MethodCommand(private val docIndexMap: DocIndexMap, private val slashDocsController: SlashDocsController) {
    @AppDeclaration
    fun declare(manager: GuildApplicationCommandManager) {
        manager.slashCommand("method", CommandScope.GUILD) {
    ...
    suspend fun onSlashMethod(
        ...
        slashDocsController.handleMethodDocs(event, className, methodSignature, docIndex) {
